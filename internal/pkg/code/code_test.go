...
func TestFrontendErrorCodesInSync(t *testing.T) {
	backend := map[string]int{
		...
		"ChannelNameInvalid":           ChannelNameInvalid,
		"ChannelNameDuplicate":         ChannelNameDuplicate,
		"ChannelHostRequired":          ChannelHostRequired,
		"ChannelPortInvalid":           ChannelPortInvalid,
		"ChannelUserRequired":          ChannelUserRequired,
		"ChannelPasswordRequired":      ChannelPasswordRequired,
		"ChannelPrivateKeyRequired":    ChannelPrivateKeyRequired,
		"ChannelSOCKS5CredentialPair":  ChannelSOCKS5CredentialPair,
		"ChannelPassphraseMissing":     ChannelPassphraseMissing,
		"ChannelPassphraseWrong":       ChannelPassphraseWrong,
		"ChannelKeyInvalid":            ChannelKeyInvalid,
		"ChannelViaCycle":              ChannelViaCycle,
		"ChannelChainTooLong":          ChannelChainTooLong,
		"ChannelHostKeyChanged":        ChannelHostKeyChanged,
		"ChannelInUse":                 ChannelInUse,
		"DataSourceNameInvalid":        DataSourceNameInvalid,
		"DataSourceNameDuplicate":      DataSourceNameDuplicate,
		"DataSourceHostRequired":       DataSourceHostRequired,
		"DataSourcePortInvalid":        DataSourcePortInvalid,
		"DataSourceUserRequired":       DataSourceUserRequired,
		"DataSourcePasswordRequired":   DataSourcePasswordRequired,
		"DataSourcePrivateKeyRequired": DataSourcePrivateKeyRequired,
		"DataSourcePassphraseMissing":  DataSourcePassphraseMissing,
		"DataSourcePassphraseWrong":    DataSourcePassphraseWrong,
		"DataSourceKeyInvalid":         DataSourceKeyInvalid,
		"DataSourceTLSPairRequired":    DataSourceTLSPairRequired,
		"DataSourceCAInvalid":          DataSourceCAInvalid,
